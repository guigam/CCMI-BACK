...
class Inscription(models.Model):
    ...
    InscriptionDateDebut = models.DateTimeField(auto_now_add=True,blank=True)
    InscriptionDateFin = models.DateTimeField(auto_now_add=True,blank=True)
    InscriptionDateMiseEnLigne = models.DateTimeField(auto_now_add=True,blank=True)
...
class Enfant(models.Model):
    ...
    DateNaissance = models.DateTimeField(auto_now_add=True,blank=True)
